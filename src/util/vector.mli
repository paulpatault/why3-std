...
(** [append a1 a2] returns a fresh vector containing
...
val push: 'a t -> 'a -> unit
(** [push a x] appends [x] at the end of vector [a], i.e.,
...
val pop: 'a t -> 'a
(** [pop a] removes and returns the rightmost element in vector [a],
